  ...
  def buildings do
    [
      %Building{
        id: 1,
        key: :building_1,
        build_time: fn level -> (200 + 500 * level + :math.pow(level, 1.8) |> round) * 1_000_000 end,
        costs: fn level ->
          %{
      ...
      %Building{
        id: 2,
        key: :building_2,
        build_time: fn level -> (200 + 1000 * level + :math.pow(level, 2.6) |> round) * 1_000_000 end,
        costs: fn level ->
          %{
          resource_1: level * 1 + 1,
          resource_2: level * 1 + 1,
      ...
      %Building{
        id: 6,
        key: :building_6,
        build_time: fn level -> (200 + 400 * level + :math.pow(level, 2.2) |> round) * 1_000_000 end,
        costs: fn level ->
          %{
