defmodule LaFamiglia.ComebackMovementTest do
  ...
  test "from_attack" do
    ...
    assert DateTime.compare(get_field(comeback, :arrives_at), attack.arrives_at) == :gt
  end
  ...
  test "from_occupation" do
    ...
    assert DateTime.compare(get_field(comeback, :arrives_at), occupation.succeeds_at) == :gt
